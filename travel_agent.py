...
def _verify_itinerary(trace: AgentTrace, user_message: str, response: str) -> TravelVerdict:
    ...
    reply = llm.chat(
        prompt=(
            ...
            "If ITINERARY, check ONLY these 5 criteria — do not invent others:\n"
            ...
            "Do NOT flag: heading wording, tone, style, group size labels, meta-questions, or anything not in the 5 criteria above.\n"
